  ...
  return (
    <SafeAreaView className="bg-black w-full h-screen">
        ...
        {sphotoUri ? (
          <View className="relative w-full h-full">
            <Image
              ...
              className="absolute rounded-md overflow-hidden top-3 left-3 w-[120px] h-[160px] z-10"
            />
            <Image
      ...
      <View className="h-[15%] relative w-full">
        {sphotoUri ? (
          <>
            <TouchableOpacity className="absolute left-7 top-10" onPress={retake}>
              <LinearGradient
                colors={[
            ...
            <TouchableOpacity className="absolute right-7 top-10">
              <LinearGradient
                colors={[
                  "rgba(255, 255, 255, 0.5)",
                  "rgba(255, 255, 255, 0)",
